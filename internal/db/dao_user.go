...
func (db *DBConnection) CreateUser(userData models.Users) (userID uuid.UUID, err error) {
...
func (db *DBConnection) ReadUser(userData models.Users) (models.Users, error) {
	var user models.Users
	var ctx = context.Background()
